...
日本語サイト（vietis.co.jp）と英語サイト（vietis.com.vn）はコンテンツの方向性が異なるため、**Strapiは日英で別々のサーバーを立てる**方針とする。

| | 日本語サイト用Strapi | 英語サイト用Strapi |
|---|---|---|
| 構築担当 | ベトナム側 | ベトナム側 |
| コンテンツ管理 | 日本側（渡辺） | ベトナム側 |
| 記事の方向性 | 技術・DX・AI系 | ベトナム側に一任 |

このREADMEは**日本語サイト用Strapi**の仕様を記載する。英語サイト用Strapiの仕様はベトナム側で別途定義する。
