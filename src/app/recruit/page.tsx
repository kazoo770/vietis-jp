...
.page-hero-inner{padding:clamp(80px,11vw,160px) 0 clamp(96px,13vw,180px);position:relative;z-index:2;max-width:40%}
...
@media(max-width:768px){
  ...
  .page-hero-inner{max-width:100%;padding:20px 0 28px;text-align:left}
