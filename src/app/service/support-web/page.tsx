...
export const metadata: Metadata = {
  title: 'Webサイト運用保守｜公開後も、成果を出し続ける - VIETISジャパン',
  description: 'コーポレートサイト・LPの公開後を継続支援。更新代行・SEO改善・パフォーマンス監視まで一気通貫。月額応相談。',
};
...
.breadcrumb{display:flex;align-items:center;gap:6px;font-size:12px;color:var(--subtle);margin-bottom:28px;flex-wrap:wrap}
...
@media(max-width:1024px){.svc-menu-grid{grid-template-columns:repeat(2,1fr)}.why-grid{grid-template-columns:repeat(2,1fr)}.why-item:nth-child(2){border-right:none}.why-item:nth-child(1),.why-item:nth-child(2){border-bottom:1px solid var(--border)}}
@media(max-width:768px){.header-nav,.header-lang,.header-actions{display:none}.hamburger{display:flex}.header-inner{grid-template-columns:auto 1fr}.pitch-grid{grid-template-columns:1fr}.svc-menu-grid{grid-template-columns:1fr}.pricing-grid{grid-template-columns:1fr}.cases-grid{grid-template-columns:1fr}.why-grid{grid-template-columns:1fr}.why-item{border-right:none;border-bottom:1px solid var(--border)}.why-item:last-child{border-bottom:none}.cta-band-inner{grid-template-columns:1fr}.footer-top{grid-template-columns:1fr 1fr}}
...
<div className="page-hero">
  <div className="wrap">
    <div className="page-hero-inner">
      <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">›</span><a href="/service">サービス</a><span className="breadcrumb-sep">›</span><span aria-current="page">Webサイト運用保守</span></nav>
      <h1 className="page-hero-h1 reveal d1">Webサイト運用保守</h1>
      <p className="page-hero-sub reveal d2" style={{maxWidth: '680px'}}>公開後のWebサイトを継続的に支援。コンテンツ更新・SEO改善・セキュリティ管理まで同一チームが担当します。</p>
    ...
    <div className="pitch-grid">
      <div>
        ...
        <div className="pitch-problem-list">
          <div className="pitch-prob-item reveal d1"><p className="pitch-prob-text">サイト公開後の更新・修正を制作会社に都度依頼するのが煩雑でコストがかさむ</p></div>
          <div className="pitch-prob-item reveal d2"><p className="pitch-prob-text">CMSがあるが使いこなせず、社内で更新できていない</p></div>
          <div className="pitch-prob-item reveal d3"><p className="pitch-prob-text">SEO対策・Core Web Vitals改善を誰に頼めばいいか分からない</p></div>
          <div className="pitch-prob-item reveal d4"><p className="pitch-prob-text">WordPressのプラグイン更新やセキュリティ対策が後手に回っている</p></div>
        </div>
      </div>
      <div>
        ...
        <div className="pitch-solution-list">
          <div className="pitch-sol-item reveal d1">
            <div className="pitch-sol-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></div>
            <div><div className="pitch-sol-title">更新代行で担当者の負担ゼロに</div><div className="pitch-sol-desc">コンテンツ更新・バナー差し替え・ページ追加まで一括代行。担当者はコア業務に集中できます。</div></div>
          </div>
          <div className="pitch-sol-item reveal d2">
            <div className="pitch-sol-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg></div>
            <div><div className="pitch-sol-title">SEOと成果改善まで踏み込む</div><div className="pitch-sol-desc">アクセス解析・Core Web Vitals改善・コンテンツSEO施策まで。公開後もサイトの成果を高め続けます。</div></div>
          </div>
          <div className="pitch-sol-item reveal d3">
            ...
            <div><div className="pitch-sol-title">セキュリティ管理を継続対応</div><div className="pitch-sol-desc">CMS・プラグインの定期更新・脆弱性パッチ適用・バックアップ管理でサイトを安全に保ちます。</div></div>
          </div>
        </div>
      </div>
    </div>
...
<section className="section">
  <div className="wrap">
    ...
    <p className="body-lead reveal d1" style={{marginTop: '16px'}}>Webサイトの安定運用から成果向上まで、公開後に必要な全業務をカバーします。</p>
    <div className="svc-menu-grid">
      <div className="svc-menu-item reveal">
        ...
        <div className="svc-menu-item-title">コンテンツ更新代行</div>
        <div className="svc-menu-item-desc">テキスト・画像・バナーの差し替え、ページ追加・削除。CMS操作から直接実装まで対応。</div>
      </div>
      <div className="svc-menu-item reveal d1">
        ...
        <div className="svc-menu-item-title">セキュリティ管理</div>
        <div className="svc-menu-item-desc">CMS・プラグイン・テーマの定期更新、脆弱性診断、バックアップ管理、SSL証明書管理。</div>
      </div>
      <div className="svc-menu-item reveal d2">
        ...
        <div className="svc-menu-item-title">表示速度・パフォーマンス改善</div>
        <div className="svc-menu-item-desc">Core Web Vitals計測・改善、画像最適化、キャッシュ設定、CDN活用による高速化対応。</div>
      </div>
      <div className="svc-menu-item reveal">
        ...
        <div className="svc-menu-item-title">SEO改善・アクセス解析</div>
        <div className="svc-menu-item-desc">Search Console・GA4を活用した流入分析・キーワード最適化・内部SEO改善の継続実施。</div>
      </div>
      <div className="svc-menu-item reveal d1">
        <div className="svc-menu-item-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg></div>
        <div className="svc-menu-item-title">障害対応・緊急修正</div>
        <div className="svc-menu-item-desc">サイト表示崩れ・フォーム障害・ダウン時の緊急対応。原因特定と修正を迅速に実施。</div>
      </div>
      <div className="svc-menu-item reveal d2">
        <div className="svc-menu-item-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div>
        <div className="svc-menu-item-title">月次レポート・改善提案</div>
        <div className="svc-menu-item-desc">アクセス状況・更新履歴・SEO動向を月次レポートで報告。次期改善施策の提案も実施。</div>
      </div>
    </div>
  </div>
</section>
...
<section className="section">
  <div className="wrap">
    ...
    <p className="body-lead reveal d1" style={{marginTop: '16px', maxWidth: 'none'}}>サイト規模・更新頻度・対応範囲に応じてご提案します。まずはご相談ください。</p>
    <div className="pricing-grid">
      <div className="pricing-card reveal">
        <div className="pricing-card-label">PLAN A</div>
        <div className="pricing-card-name">ライトプラン</div>
        <div className="pricing-card-desc">更新頻度が低いサイトの基本保守とセキュリティ管理に特化したプラン。</div>
        <div className="pricing-card-price"><span className="pricing-num" style={{fontSize: '28px'}}>応相談</span></div>
        <div className="pricing-note">サイト規模・更新頻度により見積もり</div>
        <div className="pricing-divider"></div>
        <ul className="pricing-features">
          <li className="pricing-feature">月4回までのコンテンツ更新</li>
          <li className="pricing-feature">CMS・プラグイン定期更新</li>
          <li className="pricing-feature">バックアップ管理</li>
          <li className="pricing-feature">月次稼働レポート</li>
        </ul>
      </div>
      <div className="pricing-card reveal d1">
        ...
        <div className="pricing-card-desc">更新代行に加え、SEO改善・パフォーマンス最適化も含む標準プラン。</div>
        <div className="pricing-card-price"><span className="pricing-num" style={{fontSize: '28px'}}>応相談</span></div>
        <div className="pricing-note">サイト規模・更新頻度により見積もり</div>
        <div className="pricing-divider"></div>
        <ul className="pricing-features">
          <li className="pricing-feature">無制限コンテンツ更新</li>
          <li className="pricing-feature">セキュリティ管理・脆弱性対応</li>
          <li className="pricing-feature">Core Web Vitals改善</li>
          <li className="pricing-feature">SEO分析・改善提案</li>
          <li className="pricing-feature">月次改善レポート</li>
        </ul>
      </div>
      <div className="pricing-card reveal d2">
        ...
        <div className="pricing-card-desc">大規模サイト・高頻度更新・成果改善まで全面的にサポートするプラン。</div>
        <div className="pricing-card-price"><span className="pricing-num" style={{fontSize: '28px'}}>応相談</span></div>
        <div className="pricing-note">サイト規模・更新頻度により見積もり</div>
        <div className="pricing-divider"></div>
        <ul className="pricing-features">
          <li className="pricing-feature">担当者アサイン・専任対応</li>
          <li className="pricing-feature">コンテンツ制作・ライティング</li>
          <li className="pricing-feature">A/Bテスト・CVR改善</li>
          <li className="pricing-feature">多言語サイト更新対応</li>
          <li className="pricing-feature">機能追加・デザイン改修</li>
        </ul>
      </div>
    </div>
    <p style={{marginTop: '20px', fontSize: '12px', color: 'var(--subtle)'}}>※ サイト規模・更新頻度・対応範囲によって月額は変動します。まずはご相談ください。</p>
  </div>
</section>
    ...
    <div className="cases-grid">
      <article className="case-card reveal">
        <div className="case-card-inner">
          <div className="case-thumb"><img src="https://picsum.photos/seed/supweb2025a/720/450" alt="製造業 コーポレートサイト運用保守事例" /></div>
          <div className="case-tags"><span className="tag tag-ind">製造</span><span className="tag tag-svc">Webサイト運用保守</span></div>
          <h3 className="case-title">グローバルコーポレートサイトの多言語運用を継続支援。月次更新代行とSEO改善で有機流入が1.8倍に増加</h3>
        </div>
      </article>
      <article className="case-card reveal d1">
        <div className="case-card-inner">
          <div className="case-thumb"><img src="https://picsum.photos/seed/supweb2025b/720/450" alt="教育 サービスサイト運用保守事例" /></div>
          <div className="case-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">Webサイト運用保守</span></div>
          <h3 className="case-title">教育サービスのLP群を継続運用。CVR改善施策を定期実施し、問い合わせ獲得コストを40%削減</h3>
        </div>
      </article>
      <article className="case-card reveal d2">
        <div className="case-card-inner">
          <div className="case-thumb"><img src="https://picsum.photos/seed/supweb2025c/720/450" alt="流通 ECサイト運用保守事例" /></div>
          <div className="case-tags"><span className="tag tag-ind">流通・小売</span><span className="tag tag-svc">ECサイト運用保守</span></div>
          <h3 className="case-title">ECサイトの運用保守を長期担当。セキュリティ強化・表示速度改善でサイト信頼性と購買率が向上</h3>
        </div>
      </article>
    </div>
  </div>
...
<section className="section">
  <div className="wrap">
    ...
    <div className="why-grid">
      <div className="why-item reveal d1"><div className="why-num">01</div><div className="why-item-title">制作チームが継続して保守</div><div className="why-item-body">制作から運用保守まで同一チームが担当。サイトの背景を熟知したエンジニアが迅速に対応します。</div></div>
      <div className="why-item reveal d2"><div className="why-num">02</div><div className="why-item-title">保守しながら成果も改善</div><div className="why-item-body">更新代行にとどまらず、SEO改善・CVR最適化・パフォーマンス向上まで成果を高め続けます。</div></div>
      ...
      <div className="why-item reveal d4"><div className="why-num">04</div><div className="why-item-title">規模を問わない対応力</div><div className="why-item-body">LP1ページから大規模多言語サイトまで、サイトの規模・種類を問わず対応します。</div></div>
    </div>
  </div>
</section>
...
<section className="cta-band">
  <div className="wrap">
    <div className="cta-band-inner">
      <div><h2 className="cta-head reveal">まずは<br />無料相談から</h2><p className="cta-sub reveal d1">現在のサイト状況をお聞きし、最適な運用保守体制をご提案します。</p></div>
      <div className="cta-actions reveal d2">
        <div className="cta-action-row"><div><div className="cta-action-title">無料相談を予約</div><div className="cta-action-desc">オンライン30分。現状ヒアリングと運用体制のご提案。</div></div><a href="/consultation" className="btn btn-white">予約する <span className="btn-arrow" style={{color: 'var(--ink)'}}>↗</span></a></div>
