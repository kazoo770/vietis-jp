...
export const metadata: Metadata = {
  title: '業務システム・アプリ運用保守｜稼働を守り、改善を続ける - VIETISジャパン',
  description: '業務システム・アプリの安定稼働を継続的に支援。障害対応・バージョンアップ・機能改善まで一気通貫。月額40万円〜。',
};
    ...
    <div className="pitch-grid">
      <div>
        ...
        <div className="pitch-problem-list">
          <div className="pitch-prob-item reveal d1"><p className="pitch-prob-text">開発会社との契約が終わり、障害発生時に頼れる先がなくなった</p></div>
          <div className="pitch-prob-item reveal d2"><p className="pitch-prob-text">OSやフレームワークのバージョンアップ対応が後手に回っている</p></div>
          <div className="pitch-prob-item reveal d3"><p className="pitch-prob-text">運用しながら機能追加・改善もしたいが、社内リソースが足りない</p></div>
          <div className="pitch-prob-item reveal d4"><p className="pitch-prob-text">引き継ぎ資料が不十分で、保守会社を変えるたびに品質が落ちる</p></div>
        </div>
      </div>
      <div>
        ...
        <div className="pitch-solution-list">
          <div className="pitch-sol-item reveal d1">
            ...
            <div><div className="pitch-sol-title">稼働監視と迅速な障害対応</div><div className="pitch-sol-desc">24時間の稼働監視体制とSLAに基づく障害対応。コードへの深い理解を持つエンジニアが直接対応します。</div></div>
          </div>
          <div className="pitch-sol-item reveal d2">
            ...
            <div><div className="pitch-sol-title">保守しながら改善も継続</div><div className="pitch-sol-desc">障害対応・バグ修正にとどまらず、機能追加・UX改善・パフォーマンス最適化も月額内で対応します。</div></div>
          </div>
          <div className="pitch-sol-item reveal d3">
            ...
            <div><div className="pitch-sol-title">技術的負債を計画的に解消</div><div className="pitch-sol-desc">バージョンアップ対応・セキュリティパッチ・リファクタリングを計画的に実施。長期安定稼働を支えます。</div></div>
          </div>
        </div>
      </div>
    </div>
...
<section className="section">
  <div className="wrap">
    ...
    <p className="body-lead reveal d1" style={{marginTop: '16px'}}>業務システム・アプリの安定稼働から継続的改善まで、全業務をカバーします。</p>
    <div className="svc-menu-grid">
      <div className="svc-menu-item reveal">
        ...
        <div className="svc-menu-item-title">稼働監視・アラート対応</div>
        <div className="svc-menu-item-desc">サーバー・アプリ・DBの稼働状況を継続監視。異常検知時は即時アラートと一次対応を実施。</div>
      </div>
      <div className="svc-menu-item reveal d1">
        ...
        <div className="svc-menu-item-title">障害対応・バグ修正</div>
        <div className="svc-menu-item-desc">障害発生時の原因特定・緊急修正・再発防止策の実施。SLAに基づく対応時間を保証します。</div>
      </div>
      <div className="svc-menu-item reveal d2">
        ...
        <div className="svc-menu-item-title">バージョンアップ・セキュリティ対応</div>
        <div className="svc-menu-item-desc">OS・フレームワーク・ライブラリの更新対応。セキュリティ脆弱性への迅速なパッチ適用。</div>
      </div>
      <div className="svc-menu-item reveal">
        ...
        <div className="svc-menu-item-title">機能追加・改善開発</div>
        <div className="svc-menu-item-desc">業務変化に応じた機能追加・UX改善・パフォーマンス最適化。月額内での小規模開発に対応。</div>
      </div>
      <div className="svc-menu-item reveal d1">
        <div className="svc-menu-item-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg></div>
        <div className="svc-menu-item-title">データベース管理・最適化</div>
        <div className="svc-menu-item-desc">定期バックアップ・パフォーマンス監視・クエリ最適化・容量管理を継続実施。</div>
      </div>
      <div className="svc-menu-item reveal d2">
        ...
        <div className="svc-menu-item-title">月次レポート・技術相談</div>
        <div className="svc-menu-item-desc">稼働状況・対応履歴・改善提案を月次レポートで報告。技術的な相談窓口として継続サポート。</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div className="wrap">
    ...
    <div className="pricing-grid">
      <div className="pricing-card reveal">
        ...
        <div className="pricing-card-desc">小規模システム・アプリの基本監視と障害対応に特化したプラン。</div>
        <div className="pricing-card-price"><span className="pricing-num">40</span><span className="pricing-unit">万円〜 / 月</span></div>
        ...
        <ul className="pricing-features">
          ...
          <li className="pricing-feature">軽微なバグ修正</li>
        </ul>
      </div>
      <div className="pricing-card reveal d1">
        ...
        <div className="pricing-card-desc">障害対応に加え、機能改善・バージョンアップ対応も含む標準プラン。</div>
        <div className="pricing-card-price"><span className="pricing-num">80</span><span className="pricing-unit">万円〜 / 月</span></div>
        <div className="pricing-note">最低契約期間: 3ヶ月</div>
        <div className="pricing-divider"></div>
        <ul className="pricing-features">
          <li className="pricing-feature">24時間監視・障害対応</li>
          <li className="pricing-feature">バージョンアップ対応</li>
          <li className="pricing-feature">機能追加・改善開発</li>
          <li className="pricing-feature">DB管理・最適化</li>
      ...
      <div className="pricing-card reveal d2">
        ...
        <div className="pricing-card-desc">大規模・複雑なシステムの全面的な保守・改善・拡張に対応するプラン。</div>
        <div className="pricing-card-price"><span className="pricing-num">150</span><span className="pricing-unit">万円〜 / 月</span></div>
        ...
        <ul className="pricing-features">
          ...
          <li className="pricing-feature">大規模機能追加対応</li>
          <li className="pricing-feature">技術的負債解消計画</li>
          <li className="pricing-feature">セキュリティ診断・対応</li>
        </ul>
      </div>
    </div>
    ...
    <div className="cases-grid">
      <article className="case-card reveal">
        <div className="case-card-inner">
          <div className="case-thumb"><img src="https://picsum.photos/seed/supsys2025a/720/450" alt="製造業 基幹システム保守事例" /></div>
          <div className="case-tags"><span className="tag tag-ind">製造</span><span className="tag tag-svc">業務システム保守</span></div>
          <h3 className="case-title">製造業の基幹システムを長期保守。バージョンアップ対応と継続的改善で10年以上の安定稼働を実現</h3>
        </div>
      </article>
      <article className="case-card reveal d1">
        <div className="case-card-inner">
          <div className="case-thumb"><img src="https://picsum.photos/seed/supsys2025b/720/450" alt="流通 在庫管理アプリ保守事例" /></div>
          <div className="case-tags"><span className="tag tag-ind">流通・小売</span><span className="tag tag-svc">アプリ運用保守</span></div>
          <h3 className="case-title">倉庫管理アプリの運用保守を継続支援。月次改善サイクルで機能拡張しながらダウンタイムゼロを維持</h3>
        </div>
      </article>
      <article className="case-card reveal d2">
        <div className="case-card-inner">
          <div className="case-thumb"><img src="https://picsum.photos/seed/supsys2025c/720/450" alt="教育 学習管理システム保守事例" /></div>
          <div className="case-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">業務システム保守</span></div>
          <h3 className="case-title">学習管理システムの運用保守を担当。セキュリティ強化・機能改善を並行実施し、利用者満足度が向上</h3>
        </div>
      </article>
    </div>
  </div>
...
<section className="section">
  <div className="wrap">
    ...
    <div className="why-grid">
      ...
      <div className="why-item reveal d2"><div className="why-num">02</div><div className="why-item-title">保守しながら改善も継続</div><div className="why-item-body">障害対応だけでなく、機能追加・UX改善・パフォーマンス最適化も月額内で対応。システムが進化し続けます。</div></div>
      ...
      <div className="why-item reveal d4"><div className="why-num">04</div><div className="why-item-title">規模を問わない対応力</div><div className="why-item-body">小規模アプリから大規模基幹システムまで、システムの規模・複雑さを問わず対応します。</div></div>
    </div>
  </div>
</section>
...
<section className="cta-band">
  <div className="wrap">
    <div className="cta-band-inner">
      <div><h2 className="cta-head reveal">まずは<br />無料相談から</h2><p className="cta-sub reveal d1">現在のシステム状況をお聞きし、最適な保守体制をご提案します。</p></div>
