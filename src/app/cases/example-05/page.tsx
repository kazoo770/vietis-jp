...
export const metadata: Metadata = {
  title: '教育現場のDXを支える教師向け総合情報プラットフォームの機能拡張 - VIETISジャパン',
  description: 'ヘッドレスCMSによるモダン化で情報発信スピードを大幅改善。教師向け総合情報プラットフォーム機能拡張の実績詳細。',
};
  ...
  <div className="wrap">
    <div className="page-hero-inner">
      <nav className="breadcrumb reveal">
        ...
        <span aria-current="page">教師向け総合情報プラットフォーム機能拡張</span>
      </nav>
    </div>
  </div>
</div>
  ...
  <div className="wrap">
    <div className="case-body">
      <div className="case-hero-img reveal">
        <img src="https://picsum.photos/seed/vietis-case-teacherpf/1200/675" alt="教師向け総合情報プラットフォーム" loading="eager" />
      </div>
      <div className="case-title-block reveal">
        ...
        <h1 className="page-hero-h1">教育現場のDXを支える教師向け総合情報プラットフォームの機能拡張</h1>
      </div>
      <div className="case-section reveal">
        <h2 className="case-h2">プロジェクト概要</h2>
        <p className="case-p">従業員3,000名以上の大手教育サービス企業が運営する教師向け情報プラットフォームにおいて、コンテンツ増加と更新頻度の高まりに既存CMSが追いつかない状況が生じていた。情報発信のスピードと柔軟性を抜本的に改善する必要があった。</p>
        <p className="case-p">VIETISはヘッドレスCMS（Contentful）への移行とNext.jsによるフロントエンドのモダン化を担当。コンテンツ編集者が直感的に操作できる環境を構築しながら、高速なページ表示とSEO対応を同時に実現した。</p>
      </div>
      <div className="case-section reveal">
        ...
        <div className="cs-grid">
          <div className="cs-card">
            ...
            <p className="cs-card-text">従来のCMSではコンテンツ公開に技術担当者の関与が必要で、教育現場のタイムリーな情報発信が妨げられていた。ページ表示速度の低下もユーザー離脱の原因となっていた。</p>
          </div>
          <div className="cs-card">
            <p className="cs-card-label">SOLUTION</p>
            <p className="cs-card-text">Contentfulをヘッドレスとして採用し、Next.jsのSSG/ISRによる高速配信を実現。コンテンツ編集者が開発者なしで公開操作できる環境を整備し、情報発信サイクルを大幅に短縮した。</p>
          </div>
        </div>
      </div>
      <div className="case-section reveal">
        ...
        <ul className="case-ul">
          <li>コンテンツ公開リードタイムが大幅短縮。教育現場のリアルタイムな情報発信が可能に。</li>
          <li>Core Web Vitals スコアが改善し、ページ表示速度が向上。ユーザー離脱率が低下。</li>
          <li>編集者が技術担当者不在でもコンテンツを自律的に管理できる体制を確立。</li>
          <li>API連携による外部データとの統合が容易になり、機能拡張の自由度が大幅に向上。</li>
        </ul>
      </div>
      <div className="case-section reveal">
        <h2 className="case-h2">進め方</h2>
        <div className="process-list">
          <div className="process-item"><div className="process-num">01</div><div><div className="process-title">現状調査・移行方針の策定</div><div className="process-desc">既存CMSのコンテンツ構造を分析し、Contentfulへの移行方針と優先順位を整理。並行稼働期間も含めた移行計画を策定した。</div></div></div>
          <div className="process-item"><div className="process-num">02</div><div><div className="process-title">Contentfulコンテンツモデル設計</div><div className="process-desc">編集者の操作性を重視したコンテンツモデルを設計。ブロック型のコンポーネント構造により柔軟なページ制作を可能にした。</div></div></div>
          <div className="process-item"><div className="process-num">03</div><div><div className="process-title">Next.jsフロントエンド実装</div><div className="process-desc">SSG/ISRを活用した高速フロントエンドを実装。TypeScriptによる型安全な開発とVercelへの自動デプロイを構成した。</div></div></div>
          <div className="process-item"><div className="process-num">04</div><div><div className="process-title">コンテンツ移行・編集者トレーニング・本番切り替え</div><div className="process-desc">既存コンテンツの一括移行スクリプトを整備。編集者向けトレーニングを実施したうえで本番切り替えを完了した。</div></div></div>
        </div>
      </div>
    </div>
    <aside className="case-sidebar">
      <div className="sidebar-card">
        ...
        <div className="sidebar-row">
          ...
          <div className="sidebar-item"><span className="sidebar-item-label">従業員規模</span><span className="sidebar-item-value">3,000名以上</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">支援期間</span><span className="sidebar-item-value">継続中</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">5名（PM・フロントエンド・バックエンド）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Contentful / Next.js / TypeScript / Vercel</span></div>
...
<section className="related">
  <div className="wrap">
    ...
    <div className="related-grid">
      <article className="related-card reveal"><a href="/cases/example-04/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-edusite/720/450" alt="大手教育企業コーポレートサイト" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">CMS</span></div><h3 className="related-title"><a href="/cases/example-04/">大手教育サービス企業・コーポレートサイトの構築・10年超の運用保守</a></h3></div></article>
