...
export const metadata: Metadata = {
  title: '大手IT企業と連携した自治体向けAIスタッフ総合案内チャットボットの開発・運用 - VIETISジャパン',
  description: '行政窓口の複数分野をAIが横断的に案内。大手IT企業との協業で実現した自治体向けAIチャットボットの実績詳細。',
};
...
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-govai/1200/675" alt="大手IT企業と連携した自治体向けAIスタッフ総合案内チャットボットの開発・運用" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-ind">公共・自治体</span>
<span className="tag tag-svc">AI</span>
<span className="tag tag-feat">チャットボット・RAG</span></div>
      <h1 className="page-hero-h1">大手IT企業と連携した自治体向けAIスタッフ総合案内チャットボットの開発・運用</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">大手IT企業とのパートナーシップのもと、自治体の行政窓口向けAI総合案内チャットボットの開発・運用を担当。税・福祉・手続き・施設案内など複数の行政分野を横断的にAIがリアルタイムで案内する仕組みを構築した。</p>
      <p className="case-p">VIETISはAzure OpenAI ServiceとRAGアーキテクチャを活用したバックエンドシステムと管理インターフェースの開発を担当。自治体の大量の手続き情報・FAQ・条例データをベクトルDBに格納し、市民からの問い合わせに即時・正確に回答できる基盤を構築した。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">行政分野は扱う情報の範囲が広く、かつ正確性と最新性が求められる。AIが誤った情報を提供するリスクを最小化しつつ、複数の行政分野を横断した問い合わせに対応できる設計が必要だった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">Azure OpenAIのRAGアーキテクチャで庁内ドキュメントを参照して回答を生成する構造を採用。回答根拠となる文書を提示することでハルシネーションリスクを低減。管理者が情報を随時更新できる運用管理画面も整備した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>複数の行政分野を横断する問い合わせにAIが一元対応できる環境を構築。</li>
<li>24時間対応が可能になり、窓口外時間の問い合わせにもリアルタイムで案内できるように。</li>
<li>回答根拠文書の提示によりAI回答への市民の信頼性が向上。</li>
<li>管理者による情報更新が容易になり、最新の手続き情報を常に反映できる体制を確立。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">対象行政分野の情報収集・ドキュメント整備</div><div className="process-desc">税・福祉・手続き・施設情報など対象分野のドキュメントを収集・整理。ベクトルDB格納のための前処理パイプラインを構築した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">RAGアーキテクチャ設計・Azure OpenAI連携実装</div><div className="process-desc">Azure OpenAI ServiceとAzure Cognitive Searchを組み合わせたRAGを設計・実装。プロンプトエンジニアリングで行政回答の品質を最適化した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">チャットUI・管理画面の開発</div><div className="process-desc">市民向けのシンプルなチャットインターフェースと、担当者が情報を更新・モニタリングできる管理画面を開発した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">精度検証・自治体審査対応・本番運用開始</div><div className="process-desc">模擬問い合わせでの精度検証と自治体の情報セキュリティ審査を経て本番運用を開始。継続的な精度改善も実施中。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">公共・自治体</span></div>
          ...
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">6名（PM・AIエンジニア・バックエンド・フロントエンド・QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Azure OpenAI / RAG / Python / FastAPI / Azure</span></div>
...
<article className="related-card reveal d1"><a href="/cases/example-16/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-salaryai/720/450" alt="年収査定AIチャットボット" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">業務改善・DX</span><span className="tag tag-svc">AI</span></div><h3 className="related-title"><a href="/cases/example-16/">生成AIを活用した就活生向け年収査定AIチャットボットの開発</a></h3></div></article>
<article className="related-card reveal d2"><a href="/cases/example-03/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-legacy/720/450" alt="業務システム刷新" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">業務改善・DX</span><span className="tag tag-svc">Webシステム</span></div><h3 className="related-title"><a href="/cases/example-03/">老朽化した社内コア業務システムの全面刷新・Webシステム化</a></h3></div></article></div>
</div></section>
