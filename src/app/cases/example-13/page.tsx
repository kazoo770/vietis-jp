...
export const metadata: Metadata = {
  title: '車検・洗車予約から店舗管理まで統合するサービスステーション向けLINEアプリ - VIETISジャパン',
  description: 'LINE上で予約・クーポン・ポイント・店舗スタッフ管理まで完結するミニアプリ開発の実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">›</span><a href="/cases">実績</a><span className="breadcrumb-sep">›</span><span aria-current="page">サービスステーション向けLINEアプリ開発</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-lineapp/1200/675" alt="車検・洗車予約から店舗管理まで統合するサービスステーション向けLINEアプリ" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-ind">小売・店舗</span>
<span className="tag tag-svc">LINEアプリ</span>
<span className="tag tag-feat">OCR・ポイント管理</span></div>
      <h1 className="page-hero-h1">車検・洗車予約から店舗管理まで統合するサービスステーション向けLINEアプリ</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">全国にサービスステーションを展開する企業において、車検・洗車の予約からクーポン・ポイント管理・店舗スタッフ管理まで統合するLINEミニアプリの開発を担当。最大16名体制で約6ヶ月での構築を実現した。</p>
      <p className="case-p">VIETISはLINE LIFF（LINE Front-end Framework）を活用したミニアプリのフロントエンド開発と、予約管理・スタッフ管理・ポイント管理機能のバックエンド構築を担当。リリース後も継続的な機能拡張を支援している。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">LINEプラットフォームの制約の中で、予約・クーポン・ポイント・スタッフ管理という多機能を1つのアプリに統合する設計の難しさがあった。また全国の多数の店舗それぞれの設定に対応するマルチ店舗対応も課題だった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">LIFF上でシングルページアプリとして構築し、LINE公式アカウントとのMessaging API連携でリッチな通知体験を実現。マルチ店舗対応はテナント管理構造で対応し、各店舗が独自設定できるスタッフ管理UIを構築した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>約6ヶ月でLINE上の予約・クーポン・ポイント・店舗管理を統合したアプリをリリース。</li>
<li>LINEアカウント友だち追加からそのまま予約・ポイント利用ができるシームレスな体験を実現。</li>
<li>全国の複数店舗が個別設定できるマルチテナント構造で、運用負担を最小化。</li>
<li>ポイント・クーポン機能の導入により、リピート利用率の向上に貢献。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">業務フロー・LINE要件定義</div><div className="process-desc">予約・クーポン・ポイント・スタッフ管理の業務フローを整理。LINEプラットフォームの制約と要件を照らし合わせて機能仕様を確定した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">LIFFアプリ・バックエンド開発</div><div className="process-desc">LIFF上のSPAとNode.jsバックエンドAPIを並行開発。LINE Messaging APIとの連携で予約通知・クーポン送付機能を実装した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">マルチ店舗対応・管理画面構築</div><div className="process-desc">テナント管理構造のバックエンドを設計。各店舗のスタッフが操作できる管理画面を構築した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">負荷テスト・本番リリース・継続運用</div><div className="process-desc">本番リリース前に負荷テストを実施。リリース後も機能追加・改善を継続的に担当している。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">自動車サービス</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発期間</span><span className="sidebar-item-value">約6ヶ月（最大16名体制）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">支援期間</span><span className="sidebar-item-value">支援期間</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">継続中</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">LINE LIFF / Node.js / MySQL / AWS</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">サービス種別</span><span className="sidebar-item-value">アプリ開発（LINEアプリ）</span></div>
        </div>
      </div>
...
<section className="related"><div className="wrap">
  ...
  <div className="related-grid"><article className="related-card reveal"><a href="/cases/example-07/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-bikeapp/720/450" alt="電動バイクレンタルアプリ" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">モビリティ</span><span className="tag tag-svc">アプリ</span></div><h3 className="related-title"><a href="/cases/example-07/">予約から自動解錠まで完結する電動バイクレンタルアプリの開発</a></h3></div></article>
...
<article className="related-card reveal d2"><a href="/cases/example-12/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-expense/720/450" alt="出張精算管理" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">業務改善・DX</span><span className="tag tag-svc">Webシステム</span></div><h3 className="related-title"><a href="/cases/example-12/">領収書OCR搭載・グローバル対応の出張・精算管理システム機能拡張</a></h3></div></article></div>
</div></section>
