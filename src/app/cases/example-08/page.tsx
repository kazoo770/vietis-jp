...
export const metadata: Metadata = {
  title: '国内最大級のIT・ビジネス研修企業における基幹システムの開発・保守 - VIETISジャパン',
  description: '研修受講管理・講師手配・請求まで統合した大規模基幹システムの開発・保守。130人月超の継続支援実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">/</span><a href="/cases">実績</a><span className="breadcrumb-sep">/</span><span aria-current="page">IT研修基幹システム開発・保守</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-training/1200/675" alt="国内最大級のIT・ビジネス研修企業における基幹システムの開発・保守" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-ind">教育・研修</span>
<span className="tag tag-svc">Webシステム</span>
<span className="tag tag-feat">長期継続・データ連携</span></div>
      <h1 className="page-hero-h1">国内最大級のIT・ビジネス研修企業における基幹システムの開発・保守</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">国内最大級のIT・ビジネス研修企業において、研修受講管理・講師手配・請求処理を統合する基幹システムの開発・保守を継続的に担当。130人月を超える長期支援の中で、多数の機能追加・改善を実施してきた。</p>
      <p className="case-p">受講者管理、コース管理、講師スケジュール管理、請求処理、大規模バッチ処理など、業務の根幹を支える複数のシステムを横断的に担当。ビジネスの成長とともに拡張し続けるシステムを安定して開発・運用している。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">大規模なデータ同期バッチ処理の性能問題、複雑な請求ロジックへの対応、頻繁な法改正・制度変更への追従など、基幹システムならではの高難度な課題が継続的に発生していた。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">JavaとSpring Frameworkによる堅牢なアーキテクチャを維持しながら、パフォーマンスチューニングとリファクタリングを継続。法改正への迅速な対応体制を確立し、ビジネスへの影響を最小化してきた。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>130人月超の継続的な開発・保守により、ビジネスの成長に合わせてシステムを継続拡張。</li>
<li>大規模バッチ処理の性能改善により、夜間処理の時間を大幅に短縮。</li>
<li>法改正・制度変更への追従を迅速に実施し、コンプライアンス対応を継続的にサポート。</li>
<li>蓄積した業務知識をもとに、自発的な改善提案を実施しシステム品質を向上。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">業務理解・ドキュメント整備</div><div className="process-desc">複雑な業務ロジックを持つ既存システムの仕様を丁寧に読み解き、ドキュメントを整備。保守性の向上に貢献した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">機能追加・バグ修正サイクル</div><div className="process-desc">スプリントベースの開発サイクルを確立。要件変更への柔軟な対応と品質の両立を実現している。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">パフォーマンスチューニング</div><div className="process-desc">ボトルネックとなっていたSQLとバッチ処理を改善。処理時間の大幅短縮を実現した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">法改正対応・継続的改善</div><div className="process-desc">法改正や制度変更の情報をいち早くキャッチし、リリーススケジュールを調整しながら迅速に対応している。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">教育・研修</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発規模</span><span className="sidebar-item-value">130人月超</span></div>
          ...
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Java / Spring / Oracle / AWS / バッチ処理</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">サービス種別</span><span className="sidebar-item-value">Webシステム開発・運用保守</span></div>
        </div>
      </div>
...
<section className="related"><div className="wrap">
  ...
  <div className="related-grid"><article className="related-card reveal"><a href="/cases/example-04/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-edusite/720/450" alt="教育企業コーポレートサイト" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">CMS</span></div><h3 className="related-title"><a href="/cases/example-04/">大手教育サービス企業・コーポレートサイトの構築・10年超の運用保守</a></h3></div></article>
<article className="related-card reveal d1"><a href="/cases/example-05/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-teacherpf/720/450" alt="教師向けプラットフォーム" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">CMS</span></div><h3 className="related-title"><a href="/cases/example-05/">教育現場のDXを支える教師向け総合情報プラットフォームの機能拡張</a></h3></div></article>
<article className="related-card reveal d2"><a href="/cases/example-06/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-manavis/720/450" alt="マナビジョン運用保守" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">Webシステム</span></div><h3 className="related-title"><a href="/cases/example-06/">日本最大級の高校生向け進路選択サイト「マナビジョン」システム運用保守</a></h3></div></article></div>
</div></section>
