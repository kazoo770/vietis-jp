...
export const metadata: Metadata = {
  title: '日本最大級の高校生向け進路選択サイト「マナビジョン」システム運用保守 - VIETISジャパン',
  description: '高負荷・高トラフィック環境での安定稼働を専任チームで継続支援。マナビジョンシステム運用保守の実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">/</span><a href="/cases">実績</a><span className="breadcrumb-sep">/</span><span aria-current="page">マナビジョン運用保守</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-manavis/1200/675" alt="マナビジョンシステム運用保守" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-ind">教育</span><span className="tag tag-svc">Webシステム</span><span className="tag tag-feat">長期継続・安定稼働</span></div>
      <h1 className="page-hero-h1">日本最大級の高校生向け進路選択サイト「マナビジョン」システム運用保守</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">日本最大級の高校生向け進路選択サービス「マナビジョン」において、数百万ユーザーが利用する高負荷・高トラフィック環境でのシステム運用保守を継続的に担当。大手教育サービス企業のコアシステムとして安定稼働を維持してきた。</p>
      <p className="case-p">入試シーズンの集中アクセスへの対応、定期リリースの品質担保、障害発生時の迅速な対応など、ミッションクリティカルなサービスの継続稼働を専任チームで支えている。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">年間を通じてアクセス変動が激しく、入試シーズンには通常の数倍のトラフィックが集中。サービス停止は受験生へ直接影響するため、高い可用性と迅速な障害対応が不可欠だった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">AWS上の負荷分散構成を最適化し、ピーク時のスケーリングを自動化。定期的な負荷テストと監視体制の強化により、トラブルの予防と迅速な障害対応を実現した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul">
        <li>入試シーズンを含む高負荷期の安定稼働を継続。サービス停止ゼロを維持。</li>
        <li>障害発生時の平均復旧時間を大幅短縮。ユーザー影響を最小化する体制を確立。</li>
        <li>定期リリースの品質を高水準で維持しつつ、新機能の継続的な展開を支援。</li>
        <li>長年の運用ノウハウの蓄積により、予防的なシステム改善提案も継続的に実施。</li>
      </ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list">
        <div className="process-item"><div className="process-num">01</div><div><div className="process-title">システム構成・運用フローの引き継ぎ</div><div className="process-desc">既存の運用手順・監視設定・障害対応フローを徹底的に習得。ドキュメントを整備し、属人化を解消した。</div></div></div>
        <div className="process-item"><div className="process-num">02</div><div><div className="process-title">監視体制の強化・アラート最適化</div><div className="process-desc">監視項目の見直しとアラート閾値の最適化を実施。ノイズを削減しながら重要な異常を迅速に検知できる体制を構築した。</div></div></div>
        <div className="process-item"><div className="process-num">03</div><div><div className="process-title">定期リリース・品質保証</div><div className="process-desc">リリース前の回帰テスト自動化を推進。リリース品質の安定化と作業工数の削減を同時に実現した。</div></div></div>
        <div className="process-item"><div className="process-num">04</div><div><div className="process-title">ピーク対応・継続的な改善提案</div><div className="process-desc">入試シーズン前の事前負荷テストと当日対応体制を整備。蓄積した運用データをもとに性能改善提案も継続的に実施している。</div></div></div>
      </div>
    </div>
  </div>
  <aside className="case-sidebar">
    <div className="sidebar-card">
      ...
      <div className="sidebar-row">
        ...
        <div className="sidebar-item"><span className="sidebar-item-label">規模</span><span className="sidebar-item-value">大規模（数百万ユーザー）</span></div>
        <div className="sidebar-item"><span className="sidebar-item-label">支援期間</span><span className="sidebar-item-value">継続中</span></div>
        <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">5名（PM・バックエンド・インフラ・QA）</span></div>
        <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Java / Oracle DB / AWS / 負荷分散</span></div>
        <div className="sidebar-item"><span className="sidebar-item-label">サービス種別</span><span className="sidebar-item-value">業務システム運用保守</span></div>
      </div>
    </div>
