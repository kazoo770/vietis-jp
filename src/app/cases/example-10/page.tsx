...
export const metadata: Metadata = {
  title: 'プロジェクト稼働データと自動連携する人事評価システムの構築 - VIETISジャパン',
  description: '案件管理ツールのデータを取得し評価スコアを自動算出。昇給判断を客観データで支援する人事評価システム構築の実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">/</span><a href="/cases">実績</a><span className="breadcrumb-sep">/</span><span aria-current="page">人事評価システム構築</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-hreval/1200/675" alt="プロジェクト稼働データと自動連携する人事評価システムの構築" loading="eager" /></div>
...
<span className="tag tag-feat">データ連携・API</span></div>
      <h1 className="page-hero-h1">プロジェクト稼働データと自動連携する人事評価システムの構築</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">従業員200名規模のIT・サービス企業において、プロジェクト管理ツールの稼働データと連携して人事評価スコアを自動算出するWebシステムの構築を担当。評価の属人化と担当者の工数削減が主要な目的だった。</p>
      <p className="case-p">VIETISはPython/FastAPIによるバックエンドAPIとReactによる管理画面を構築。プロジェクト管理ツール（Jira等）からのデータ自動取得・スコアリングロジックの実装・評価者向けレビューUIまでを一貫して開発した。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">評価基準が主観的で担当者によってばらつきが生じていた。また評価期間中の集計作業が担当者に大きな負担をかけており、評価の精度・公平性ともに課題感があった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">案件管理ツールのAPIから稼働実績データを自動取得し、職種別の評価ロジックに基づいてスコアを算出するシステムを構築。評価者はレビュー・コメント・最終確定に集中できるUIを整備した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>人事評価の集計作業が自動化され、評価担当者の工数を月あたり大幅削減。</li>
<li>稼働データに基づく客観スコアの導入により、評価の公平性と透明性が向上。</li>
<li>評価者は定性コメントとスコア調整に集中でき、評価プロセスの質が改善。</li>
<li>評価データがデジタル化され、年度ごとの傾向分析が容易になった。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">評価制度ヒアリング・スコアリングロジック設計</div><div className="process-desc">現行の評価基準と職種別の重み付けをヒアリング。データソース（Jira等）との連携仕様を設計した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">データ連携基盤・バックエンド構築</div><div className="process-desc">プロジェクト管理ツールAPIとの連携スクリプト、スコアリングロジック、評価データ管理APIをPython/FastAPIで実装。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">評価管理画面の開発</div><div className="process-desc">評価者がスコア確認・コメント入力・最終確定を行えるReact製の管理UIを開発。ロール管理機能も実装した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">評価サイクルでの並行テスト・本番導入</div><div className="process-desc">実際の評価期間に合わせてパイロット運用を実施。フィードバックをもとに改善を加えて本番導入した。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">IT・サービス業</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">従業員規模</span><span className="sidebar-item-value">200名</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発期間</span><span className="sidebar-item-value">数ヶ月（集中開発）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">5名（PM・バックエンド・フロントエンド・QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Python / FastAPI / React / PostgreSQL</span></div>
