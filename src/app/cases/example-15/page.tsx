...
export const metadata: Metadata = {
  title: '大手金融機関・電子マネーアプリへのQUICPay決済機能の追加カスタマイズ - VIETISジャパン',
  description: '既存電子マネーアプリへのQUICPay対応追加。セキュリティ要件が厳しい金融領域での高信頼実装の実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">/</span><a href="/cases">実績</a><span className="breadcrumb-sep">/</span><span aria-current="page">QUICPay決済機能追加</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-quicpay/1200/675" alt="大手金融機関・電子マネーアプリへのQUICPay決済機能の追加カスタマイズ" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-ind">金融・決済</span>
<span className="tag tag-svc">アプリ</span>
<span className="tag tag-feat">短期間開発</span></div>
      <h1 className="page-hero-h1">大手金融機関・電子マネーアプリへのQUICPay決済機能の追加カスタマイズ</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">大手金融機関が提供する電子マネースマートフォンアプリへ、QUICPay決済機能を追加するカスタマイズ開発を約6ヶ月・15名体制で担当。金融領域特有の厳格なセキュリティ要件と品質基準のもとで実装を完遂した。</p>
      <p className="case-p">VIETISはiOS（Swift）・Android（Kotlin）両プラットフォームの実装チームとして参画。QUICPay SDKの統合、セキュアエレメントを利用したカード情報の安全な格納、決済フローのエッジケース対応を実装した。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">金融機関のセキュリティガイドラインへの準拠、複数のデバイスモデルでのセキュアエレメント動作保証、QUICPay SDKのバージョン対応など、技術的難易度と規制対応の両面で高いハードルがあった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">金融機関のセキュリティ審査プロセスに沿って設計から実装・レビューを進行。セキュアエレメントを活用したカード情報管理を実装し、デバイスモデルごとの動作を網羅的に検証した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>約6ヶ月という期間内で金融機関のセキュリティ審査を通過し、QUICPay機能のリリースを実現。</li>
<li>iOS/Android両プラットフォームで主要デバイスモデルの動作を検証し、品質基準をクリア。</li>
<li>セキュアエレメントを活用したカード情報管理により、高水準のセキュリティ要件に対応。</li>
<li>既存アプリへのQUICPay機能追加による利便性向上で、ユーザーの決済手段の選択肢が拡大。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">セキュリティ要件確認・設計レビュー</div><div className="process-desc">金融機関のセキュリティガイドラインを精読し、設計方針を策定。审査プロセスに沿ったドキュメントを整備した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">QUICPay SDK統合・セキュアエレメント実装</div><div className="process-desc">iOS/Androidそれぞれでの SDK統合と、セキュアエレメントを利用したカード情報格納ロジックを実装した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">決済フロー実装・エッジケース対応</div><div className="process-desc">オフライン時・通信エラー時・残高不足時など多数のエッジケースを洗い出し、適切なエラーハンドリングを実装。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">多デバイス検証・セキュリティ審査対応・リリース</div><div className="process-desc">主要デバイスモデルでの実機検証を実施。金融機関のセキュリティ審査に対応し、審査通過後に本番リリースを完了した。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">金融・フィンテック</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発期間</span><span className="sidebar-item-value">約6ヶ月（15名体制）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">チーム規模</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">15名（PM・iOSエンジニア・Androidエンジニア・QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">iOS (Swift) / Android (Kotlin) / QUICPay SDK / セキュアエレメント</span></div>
