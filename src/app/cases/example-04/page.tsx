...
export const metadata: Metadata = {
  title: '大手教育サービス企業・コーポレートサイトの構築・10年超の運用保守 - VIETISジャパン',
  description: 'Webアワード受賞サイトを構築。以降10年以上の運用保守を継続している教育企業サイト構築の実績詳細。',
};
  ...
  <div className="wrap">
    <div className="case-body">
      <div className="case-hero-img reveal">
        <img src="https://picsum.photos/seed/vietis-case-edusite/1200/675" alt="大手教育企業コーポレートサイト" loading="eager" />
      </div>
      <div className="case-title-block reveal">
        ...
        <h1 className="page-hero-h1">大手教育サービス企業・コーポレートサイトの構築・10年超の運用保守</h1>
      </div>
      <div className="case-section reveal">
        <h2 className="case-h2">プロジェクト概要</h2>
        <p className="case-p">従業員5,000名以上を擁する大手教育サービス企業のコーポレートサイトをゼロから構築。デザイン性と情報設計の両面で高い評価を受け、Webアワードを受賞した。構築後は継続的な運用保守パートナーとして、10年以上にわたり同一チームで対応を続けている。</p>
        <p className="case-p">年次リニューアル、サービス追加・廃止に伴うコンテンツ整備、パフォーマンス改善など、企業のWebコミュニケーション戦略に伴走するかたちで長期的な支援を継続している。</p>
      </div>
      <div className="case-section reveal">
        ...
        <div className="cs-grid">
          <div className="cs-card">
            ...
            <p className="cs-card-text">多岐にわたる事業領域を持つ大手企業のサイト構築は、情報量・更新頻度ともに高く、社内担当者でも容易に更新できる仕組みが求められた。また長期的な保守性も重要な要件だった。</p>
          </div>
          <div className="cs-card">
            <p className="cs-card-label">SOLUTION</p>
            <p className="cs-card-text">WordPressをベースにカスタマイズしたCMS環境を構築し、担当者が直感的に更新できる管理画面を整備。AWSによる冗長構成で高可用性を実現し、10年超の安定稼働を支えている。</p>
          </div>
        </div>
      </div>
      <div className="case-section reveal">
        ...
        <ul className="case-ul">
          <li>Webアワード受賞。デザイン・UXともに業界内で高い評価を獲得。</li>
          <li>10年以上にわたる継続的な運用保守を同一チームで担当。品質と知見を蓄積。</li>
          <li>社内担当者による自律的なコンテンツ更新が可能な環境を実現し、情報鮮度が向上。</li>
          <li>サービス追加・組織変更にも柔軟に対応できる拡張性の高いサイト構造を維持。</li>
        </ul>
      </div>
      <div className="case-section reveal">
        <h2 className="case-h2">進め方</h2>
        <div className="process-list">
          <div className="process-item"><div className="process-num">01</div><div><div className="process-title">情報設計・UX設計</div><div className="process-desc">事業領域の整理と主要ターゲットへのユーザー調査をもとに、サイトの情報アーキテクチャとナビゲーション設計を策定した。</div></div></div>
          <div className="process-item"><div className="process-num">02</div><div><div className="process-title">デザイン・フロントエンド実装</div><div className="process-desc">ブランドガイドラインに準拠しつつ、Webの特性を活かしたデザインを制作。アクセシビリティ対応も考慮したフロントエンド実装を行った。</div></div></div>
          <div className="process-item"><div className="process-num">03</div><div><div className="process-title">CMS構築・CMS管理者向けトレーニング</div><div className="process-desc">WordPressカスタマイズによるCMS環境を整備。社内担当者向けの操作マニュアルと研修を実施し、スムーズな引き渡しを実現した。</div></div></div>
          <div className="process-item"><div className="process-num">04</div><div><div className="process-title">継続的な運用保守・改善提案</div><div className="process-desc">公開後も月次定例で状況を共有し、アクセス解析をもとに改善提案を継続。年次リニューアルも同一チームで対応している。</div></div></div>
        </div>
      </div>
    </div>
    <aside className="case-sidebar">
      <div className="sidebar-card">
        ...
        <div className="sidebar-row">
          ...
          <div className="sidebar-item"><span className="sidebar-item-label">従業員規模</span><span className="sidebar-item-value">5,000名以上</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">支援期間</span><span className="sidebar-item-value">10年以上継続</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">4名（PM・デザイナー・エンジニア）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">WordPress / PHP / MySQL / AWS</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">サービス種別</span><span className="sidebar-item-value">Webサイト制作・運用保守</span></div>
        </div>
      </div>
