...
export const metadata: Metadata = {
  title: '予約から自動解錠まで完結する電動バイクレンタルアプリの開発 - VIETISジャパン',
  description: 'iOS/AndroidアプリからBLE経由でバイクを自動解錠。予約・決済・返却まで完結した電動バイクレンタルアプリ開発の実績詳細。',
};
...
.breadcrumb{display:flex;align-items:center;gap:6px;font-size:12px;color:var(--subtle);margin-bottom:24px;flex-wrap:wrap}.breadcrumb a{color:var(--subtle);transition:color 0.15s}.breadcrumb a:hover{color:var(--ink)}.breadcrumb-sep{color:var(--border)}
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">›</span><a href="/cases">実績</a><span className="breadcrumb-sep">›</span><span aria-current="page">電動バイクレンタルアプリ開発</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-bikeapp/1200/675" alt="予約から自動解錠まで完結する電動バイクレンタルアプリの開発" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-feat">モビリティ・シェアリング</span>
<span className="tag tag-svc">アプリ</span>
<span className="tag tag-feat">IoT・BLE・短期間開発</span></div>
      <h1 className="page-hero-h1">予約から自動解錠まで完結する電動バイクレンタルアプリの開発</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">モビリティシェアリング事業を展開するスタートアップにおいて、電動バイクのレンタルサービスをゼロから立ち上げるためのiOS/Androidアプリ開発を担当。ユーザーが予約から解錠・返却まですべてアプリ上で完結できる仕組みが求められた。</p>
      <p className="case-p">VIETISはFlutterによるクロスプラットフォーム開発を採用し、BLE通信によるバイク自動解錠機能とStripeを使った決済機能を約5ヶ月（40人月）で実装。スピーディーなサービス立ち上げを実現した。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">BLEを使ったIoT連携の技術的難易度に加え、予約・決済・ステーション管理など複数の機能を短期間で開発する必要があった。また、iOS/Androidそれぞれでの品質担保も課題だった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">Flutterによるクロスプラットフォーム開発で開発コストを最適化しつつ、BLE通信ライブラリのカスタマイズで安定した解錠体験を実現。StripeのSDKをネイティブに統合し決済フローをシームレスに構築した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>予約から解錠・返却までをアプリ単体で完結するサービスを約5ヶ月で立ち上げ。</li>
<li>Flutterのクロスプラットフォーム対応によりiOS/Android同時リリースを実現し、開発コストを最適化。</li>
<li>BLE通信の安定性を確保し、解錠失敗率を許容範囲内に抑えることに成功。</li>
<li>Stripeによる決済フローを組み込み、スムーズな料金回収体制を構築。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">要件定義・BLE仕様確認</div><div className="process-desc">バイクのBLEモジュール仕様を確認し、解錠コマンドのプロトコルを策定。アプリで必要な機能を優先度とともに整理した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">Flutterアプリ設計・開発</div><div className="process-desc">予約・地図・決済・解錠・返却の各画面を設計。BLEプラグインのカスタマイズと決済SDK統合を並行して実装した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">バックエンド・管理画面構築</div><div className="process-desc">Node.jsによる予約管理API、ステーション管理機能、オーナー向け管理画面をAWS上に構築した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">実機テスト・リリース準備・本番公開</div><div className="process-desc">実際のバイクを使った実機テストを繰り返し実施。AppStore/GooglePlayへの審査申請から本番公開までを担当した。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">モビリティ・シェアリング</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発期間</span><span className="sidebar-item-value">約5ヶ月（40人月）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">チーム規模</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">8名（PM・Flutterエンジニア・バックエンド・QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Flutter / BLE / Node.js / Stripe / AWS</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">サービス種別</span><span className="sidebar-item-value">アプリ開発</span></div>
        </div>
      </div>
...
<section className="related"><div className="wrap">
  ...
  <div className="related-grid"><article className="related-card reveal"><a href="/cases/example-13/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-lineapp/720/450" alt="LINEアプリ" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">小売・店舗</span><span className="tag tag-svc">LINEアプリ</span></div><h3 className="related-title"><a href="/cases/example-13/">車検・洗車予約から店舗管理まで統合するサービスステーション向けLINEアプリ</a></h3></div></article>
<article className="related-card reveal d1"><a href="/cases/example-14/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-realestate/720/450" alt="不動産管理DX" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">不動産</span><span className="tag tag-svc">Webシステム</span></div><h3 className="related-title"><a href="/cases/example-14/">物件の稼働・財務状況を一目で把握する不動産管理DXシステムの構築</a></h3></div></article>
<article className="related-card reveal d2"><a href="/cases/example-15/" className="related-thumb"><img src="https://picsum.photos/seed/vietis-case-quicpay/720/450" alt="QUICPay決済" loading="lazy" /></a><div className="related-body"><div className="related-tags"><span className="tag tag-ind">金融・決済</span><span className="tag tag-svc">アプリ</span></div><h3 className="related-title"><a href="/cases/example-15/">大手金融機関・電子マネーアプリへのQUICPay決済機能の追加カスタマイズ</a></h3></div></article></div>
</div></section>
