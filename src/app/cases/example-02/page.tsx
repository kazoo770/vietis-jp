...
export const metadata: Metadata = {
  title: 'AI採用支援システム「Menraku」導入による採用プロセスの自動化 - VIETISジャパン',
  description: '書類選考〜AI面接〜スコアリングまでの採用プロセスを24時間自動化。生成AIを活用した採用DXの実績詳細。',
};
  ...
  <div className="wrap">
    <div className="case-body">
      <div className="case-hero-img reveal">
        <img src="https://picsum.photos/seed/vietis-case-menraku/1200/675" alt="AI採用支援システム" loading="eager" />
      </div>
      <div className="case-title-block reveal">
        ...
        <h1 className="page-hero-h1">AI採用支援システム「Menraku」導入による採用プロセスの自動化</h1>
      </div>
      <div className="case-section reveal">
        <h2 className="case-h2">プロジェクト概要</h2>
        <p className="case-p">従業員1,000名以上を抱える人材・HR企業において、急増する採用件数に対して担当者リソースが追いつかない状況が続いていた。書類選考・面接調整・候補者対応などの業務が煩雑化し、優秀な人材を見逃すリスクも生じていた。</p>
        <p className="case-p">VIETISは自社プロダクト「Menraku」を中心に、書類選考からAI面接・スコアリングまでの採用プロセスを一貫して24時間自動化する基盤を構築。採用担当者が本来の判断業務に集中できる環境を実現した。</p>
      </div>
      <div className="case-section reveal">
        ...
        <div className="cs-grid">
          <div className="cs-card">
            ...
            <p className="cs-card-text">採用件数の急増により、書類選考から一次面接調整まで担当者1人あたりの工数が月100時間を超える状況に。候補者への連絡遅延が辞退率増加の原因にもなっていた。</p>
          </div>
          <div className="cs-card">
            <p className="cs-card-label">SOLUTION</p>
            <p className="cs-card-text">Menrakuが書類スクリーニング・AIビデオ面接・スコアリングを自動実行。候補者は24時間いつでも面接を受けられ、担当者は高スコア候補者へのフォローに集中できる仕組みを構築した。</p>
          </div>
        </div>
      </div>
      <div className="case-section reveal">
        ...
        <ul className="case-ul">
          <li>書類選考から一次面接完了までのリードタイムが平均5日から1日以内に短縮。</li>
          <li>採用担当者の工数が月あたり約60時間削減され、戦略的採用活動に注力できる体制を構築。</li>
          <li>候補者の辞退率が大幅に改善し、内定承諾率も向上。</li>
          <li>AIスコアリングの精度向上により、採用後の定着率改善にも貢献。</li>
        </ul>
      </div>
      <div className="case-section reveal">
        ...
        <div className="process-list">
          <div className="process-item">
            ...
            <div>
              <div className="process-title">採用フロー・評価基準のヒアリング</div>
              <div className="process-desc">既存の選考ステップと評価項目を整理。Menrakuの自動化対象範囲と人的判断が必要な領域を明確化した。</div>
            </div>
          </div>
          <div className="process-item">
            <div className="process-num">02</div>
            <div>
              <div className="process-title">AIモデル・スコアリングロジックの設計</div>
              <div className="process-desc">職種ごとの評価基準をもとにGPT-4を活用したスコアリングロジックとRAGによる質問生成を実装。</div>
            </div>
          </div>
          <div className="process-item">
            <div className="process-num">03</div>
            <div>
              <div className="process-title">既存ATS・HRISとの連携構築</div>
              <div className="process-desc">既存の採用管理システムとMenrakuをAPI連携。候補者データの二重入力を排除し、一元管理できる環境を整備した。</div>
            </div>
          </div>
          <div className="process-item">
            <div className="process-num">04</div>
            <div>
              <div className="process-title">パイロット運用・精度改善・本格展開</div>
              <div className="process-desc">1職種でのパイロット導入からスタート。スコアリング精度を検証・改善したうえで全職種に展開した。</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="sidebar-card">
        ...
        <div className="sidebar-row">
          <div className="sidebar-item">
            ...
            <span className="sidebar-item-value">人材・HR</span>
          </div>
          <div className="sidebar-item">
            <span className="sidebar-item-label">従業員規模</span>
            <span className="sidebar-item-value">1,000名以上</span>
          </div>
          <div className="sidebar-item">
            <span className="sidebar-item-label">開発期間</span>
            <span className="sidebar-item-value">約6ヶ月</span>
          </div>
          <div className="sidebar-item">
            <span className="sidebar-item-label">チーム規模</span>
            <span className="sidebar-item-value">6名（PM・AIエンジニア・バックエンド・QA）</span>
          </div>
          <div className="sidebar-item">
            <span className="sidebar-item-label">技術スタック</span>
            <span className="sidebar-item-value">Python / FastAPI / GPT-4 / RAG / PostgreSQL</span>
          </div>
          <div className="sidebar-item">
            <span className="sidebar-item-label">サービス種別</span>
            <span className="sidebar-item-value">AIシステム開発</span>
          </div>
        </div>
      </div>
  ...
  <div className="wrap">
    ...
    <div className="related-grid">
      <article className="related-card reveal">
        <a href="/cases/example-16/" className="related-thumb">
          <img src="https://picsum.photos/seed/vietis-case-salaryai/720/450" alt="年収査定AIチャットボット" loading="lazy" />
        </a>
        <div className="related-body">
          <div className="related-tags"><span className="tag tag-ind">業務改善・DX</span><span className="tag tag-svc">AI</span></div>
          <h3 className="related-title"><a href="/cases/example-16/">生成AIを活用した就活生向け年収査定AIチャットボットの開発</a></h3>
        </div>
      </article>
      <article className="related-card reveal d1">
        <a href="/cases/example-17/" className="related-thumb">
          <img src="https://picsum.photos/seed/vietis-case-govai/720/450" alt="自治体向けAIチャットボット" loading="lazy" />
        </a>
        <div className="related-body">
          <div className="related-tags"><span className="tag tag-ind">業務改善・DX</span><span className="tag tag-svc">AI</span></div>
          <h3 className="related-title"><a href="/cases/example-17/">大手IT企業と連携した自治体向けAIスタッフ総合案内チャットボットの開発・運用</a></h3>
        </div>
      </article>
      <article className="related-card reveal d2">
        <a href="/cases/example-01/" className="related-thumb">
          <img src="https://picsum.photos/seed/vietis-case-keyspider-detail/720/450" alt="クラウドID管理システム" loading="lazy" />
        </a>
        <div className="related-body">
          <div className="related-tags"><span className="tag tag-ind">業務改善・DX</span><span className="tag tag-svc">Webシステム</span></div>
          <h3 className="related-title"><a href="/cases/example-01/">クラウドID管理「Keyspider」導入によるアカウント管理の自動化</a></h3>
        </div>
      </article>
    </div>
  </div>
      ...
      <div className="reveal d2">
        <div className="cta-actions">
          <div className="cta-action-row">
            <div><div className="cta-action-title">無料相談を予約</div><div className="cta-action-desc">オンライン30分。課題ヒアリングと方向性のご提案。</div></div>
            <a href="/consultation" className="btn btn-white">予約する <span className="btn-arrow" style={{color: 'var(--ink)'}}>↗</span></a>
          </div>
          <div className="cta-action-row">
            <div><div className="cta-action-title">資料ダウンロード</div><div className="cta-action-desc">サービス概要・実績・料金目安をまとめた資料。</div></div>
            <a href="/download" className="btn btn-outline-white">ダウンロード</a>
          </div>
          <div className="cta-action-row">
            <div><div className="cta-action-title">お問い合わせ</div><div className="cta-action-desc">個別のご質問・お見積りのご相談はこちらから。</div></div>
