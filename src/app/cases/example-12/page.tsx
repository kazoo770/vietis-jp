...
export const metadata: Metadata = {
  title: '領収書OCR搭載・グローバル対応の出張・精算管理システム機能拡張 - VIETISジャパン',
  description: '領収書撮影→OCR読み取り→自動仕訳。多通貨・多言語対応の精算基盤を19ヶ月にわたり継続拡張した実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">/</span><a href="/cases">実績</a><span className="breadcrumb-sep">/</span><span aria-current="page">出張・精算管理システム機能拡張</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-expense/1200/675" alt="領収書OCR搭載・グローバル対応の出張・精算管理システム機能拡張" loading="eager" /></div>
...
<span className="tag tag-feat">OCR・データ連携</span></div>
      <h1 className="page-hero-h1">領収書OCR搭載・グローバル対応の出張・精算管理システム機能拡張</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">グローバル展開する商社における出張・経費精算システムの機能拡張を19ヶ月にわたり継続担当。領収書撮影からOCR読み取り・自動仕訳・承認・支払いまでのフローを対象に、多通貨・多言語対応を含む大規模な機能追加を実施してきた。</p>
      <p className="case-p">VIETISはReact Nativeによるモバイルアプリ開発チームとしてプロジェクトに参画。OCR APIとの連携、多通貨レート自動取得、仕訳ルールエンジンの拡張など、複雑な業務ロジックを継続的に実装・保守している。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">海外出張時の外貨領収書対応（通貨変換・仕訳ルール）、OCR精度向上、各国の税務要件への対応など、グローバル企業ならではの複雑な要件が継続的に発生していた。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">OCR APIのポストプロセッシングロジックをカスタマイズして読み取り精度を向上。多通貨対応は為替レートAPI連携と仕訳テーブルの汎用化で対応。要件ごとにテスト自動化を整備し、継続拡張の品質を担保した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>19ヶ月の継続開発で主要機能を拡張し、グローバル拠点での利用率が向上。</li>
<li>OCR読み取り精度の改善により、領収書処理の手動補正工数が大幅削減。</li>
<li>多通貨対応の自動化により、海外出張の精算処理が簡素化。</li>
<li>テスト自動化の整備により、継続的なリリース品質を高水準で維持。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">機能要件ヒアリング・優先度整理</div><div className="process-desc">各拠点の経理担当者からの要件を収集し、優先度と開発順序を整理。スプリント計画に反映した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">OCR連携・多通貨機能の実装</div><div className="process-desc">OCR APIのレスポンス処理をカスタマイズし読み取り精度を向上。為替レートAPI連携と仕訳変換ロジックを実装した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">テスト自動化の整備</div><div className="process-desc">主要フローのE2Eテストを自動化。リリースごとの回帰テスト工数を削減しながら品質を維持した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">継続的なリリース・改善提案</div><div className="process-desc">スプリントサイクルで機能追加を継続。利用データを分析し、UX改善提案も積極的に実施している。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">商社・グローバル企業</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">支援期間</span><span className="sidebar-item-value">19ヶ月継続</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">チーム規模</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">6名（PM・React Native・バックエンド・QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">React Native / OCR API / Node.js / PostgreSQL / AWS</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">サービス種別</span><span className="sidebar-item-value">アプリ開発・Webシステム開発</span></div>
        </div>
      </div>
