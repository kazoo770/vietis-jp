...
export const metadata: Metadata = {
  title: '複雑な承認プロセスに対応した帳票作成・管理システムの開発 - VIETISジャパン',
  description: '多段階承認・差し戻し・PDF出力に対応。専任QAを配置し高品質・短期納品を両立した帳票管理システム開発の実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">/</span><a href="/cases">実績</a><span className="breadcrumb-sep">/</span><span aria-current="page">帳票作成・管理システム開発</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-docmgmt/1200/675" alt="複雑な承認プロセスに対応した帳票作成・管理システムの開発" loading="eager" /></div>
...
<span className="tag tag-feat">短期間開発</span></div>
      <h1 className="page-hero-h1">複雑な承認プロセスに対応した帳票作成・管理システムの開発</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">製造・建設業における現場帳票の作成・承認・管理を統合するWebシステムの開発を担当。複数の承認者・差し戻しフロー・PDF出力といった複雑な要件を、約3ヶ月という短期間で実装した。</p>
      <p className="case-p">VIETISはVue.jsによるリッチなフロントエンドとNode.jsバックエンドを構築。専任QAエンジニアをチームに配置することで、承認フローのエッジケースを網羅的にテストし、高品質な納品を実現した。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">承認ルートの柔軟な設定（部門別・金額別の多段階承認）、差し戻し時のデータ保持、PDF出力の帳票レイアウト忠実度など、要件が複雑で実装難易度が高い機能が多数あった。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">承認フローエンジンを汎用的に設計し、設定ファイルで承認ルートを柔軟に変更できる構造を採用。PDF生成はサーバーサイドレンダリングで帳票レイアウトの精度を確保。専任QAが全フローの網羅的なテストを担当した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>約3ヶ月という短期間で複雑な承認フローシステムを本番リリース。</li>
<li>専任QAによる網羅的なテストにより、リリース後の不具合を最小化。</li>
<li>帳票のデジタル化と承認プロセスの電子化により、紙ベース業務からの脱却を実現。</li>
<li>承認状況のリアルタイム確認が可能になり、承認待ち時間の短縮と業務効率化を達成。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">要件定義・承認フロー設計</div><div className="process-desc">関係部署へのヒアリングをもとに承認ルートのパターンを整理。フローエンジンの汎用設計を策定した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">フロントエンド・バックエンド並行開発</div><div className="process-desc">Vue.jsで帳票入力UIと承認ダッシュボードを開発。Node.jsでAPIと承認フローエンジンを実装した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">PDF生成機能の実装</div><div className="process-desc">帳票のデザインデータをもとにPDFレイアウトを実装。Puppeteerを活用してピクセル精度のPDF出力を実現した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">専任QAによる全フロー検証・本番リリース</div><div className="process-desc">専任QAが承認・差し戻し・権限別アクセスを網羅的にテスト。検証完了後に本番リリースを実施した。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">製造・建設</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発期間</span><span className="sidebar-item-value">約3ヶ月（専任QA配置）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">チーム規模</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">6名（PM・フロントエンド・バックエンド・専任QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">Vue.js / Node.js / PostgreSQL / PDF生成</span></div>
