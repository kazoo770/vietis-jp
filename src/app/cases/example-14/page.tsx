...
export const metadata: Metadata = {
  title: '物件の稼働・財務状況を一目で把握する不動産管理DXシステムの構築 - VIETISジャパン',
  description: '複数物件の稼働率・収支・メンテナンス履歴をダッシュボード化。現場担当の業務効率化を実現した不動産DXシステムの実績詳細。',
};
...
<div className="page-hero"><div className="wrap"><div className="page-hero-inner">
  <nav className="breadcrumb reveal"><a href="/">トップ</a><span className="breadcrumb-sep">›</span><a href="/cases">実績</a><span className="breadcrumb-sep">›</span><span aria-current="page">不動産管理DXシステム構築</span></nav>
</div></div></div>
<section className="case-layout"><div className="wrap">
  <div className="case-body">
    <div className="case-hero-img reveal"><img src="https://picsum.photos/seed/vietis-case-realestate/1200/675" alt="物件の稼働・財務状況を一目で把握する不動産管理DXシステムの構築" loading="eager" /></div>
    <div className="case-title-block reveal">
      <div className="case-tags"><span className="tag tag-ind">不動産</span>
<span className="tag tag-svc">Webシステム</span>
<span className="tag tag-feat">短期間開発</span></div>
      <h1 className="page-hero-h1">物件の稼働・財務状況を一目で把握する不動産管理DXシステムの構築</h1>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">プロジェクト概要</h2>
      <p className="case-p">複数の収益物件を管理する不動産会社において、物件ごとの稼働率・収支状況・修繕履歴を一元管理するダッシュボードシステムの構築を約3ヶ月で実施。これまでExcelで管理していた情報をリアルタイムで可視化する仕組みを実現した。</p>
      <p className="case-p">VIETISはReactによるダッシュボードフロントエンドとNode.jsバックエンドAPIを構築。Chart.jsによるグラフ表示と、物件別・月別のデータ集計機能を実装し、管理者が直感的に状況を把握できるUIを提供した。</p>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">課題と解決策</h2>
      <div className="cs-grid">
        <div className="cs-card"><p className="cs-card-label">CHALLENGE</p><p className="cs-card-text">複数の物件データがExcelやメールに散在しており、全体状況の把握に毎週大量の集計作業が発生していた。また現場担当者がスマートフォンからも確認できる環境が求められていた。</p></div>
        <div className="cs-card"><p className="cs-card-label">SOLUTION</p><p className="cs-card-text">すべてのデータを一元管理するDBを設計し、物件・部屋・入居者・収支・メンテナンス履歴を統合管理。レスポンシブ対応のダッシュボードで、PCからもスマートフォンからも同等の体験を提供した。</p></div>
      </div>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">成果</h2>
      <ul className="case-ul"><li>毎週の手集計作業が不要になり、担当者の工数を大幅に削減。</li>
<li>稼働率・収支状況がリアルタイムで可視化され、経営判断のスピードが向上。</li>
<li>メンテナンス履歴のデジタル化により、修繕対応の抜け漏れが解消。</li>
<li>スマートフォン対応により、現場担当者が外出先でもリアルタイムに状況確認が可能に。</li></ul>
    </div>
    <div className="case-section reveal">
      <h2 className="case-h2">進め方</h2>
      <div className="process-list"><div className="process-item"><div className="process-num">01</div><div><div className="process-title">現状整理・データモデル設計</div><div className="process-desc">Excelや紙で管理していたデータを整理し、一元管理に向けたデータモデルを設計。移行方針も策定した。</div></div></div>
<div className="process-item"><div className="process-num">02</div><div><div className="process-title">バックエンドAPI・DB構築</div><div className="process-desc">物件・部屋・収支・メンテナンス各エンティティのAPIをNode.jsで実装。集計クエリのパフォーマンスも最適化した。</div></div></div>
<div className="process-item"><div className="process-num">03</div><div><div className="process-title">ダッシュボードフロントエンド開発</div><div className="process-desc">ReactとChart.jsで稼働率・収支推移グラフ・アラート表示を実装。モバイル対応のレスポンシブUIを構築した。</div></div></div>
<div className="process-item"><div className="process-num">04</div><div><div className="process-title">データ移行・本番リリース・操作研修</div><div className="process-desc">既存ExcelデータのインポートスクリプトでDB移行を完了。担当者向けの操作研修を実施してスムーズに本番移行した。</div></div></div></div>
    </div>
  </div>
  <aside className="case-sidebar"><div className="sidebar-card">
        <p className="sidebar-card-title">PROJECT INFO</p>
        <div className="sidebar-row">
          <div className="sidebar-item"><span className="sidebar-item-label">業種</span><span className="sidebar-item-value">不動産</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">開発期間</span><span className="sidebar-item-value">約3ヶ月</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">チーム規模</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">チーム規模</span><span className="sidebar-item-value">5名（PM・フロントエンド・バックエンド・QA）</span></div>
          <div className="sidebar-item"><span className="sidebar-item-label">技術スタック</span><span className="sidebar-item-value">React / Node.js / PostgreSQL / Chart.js</span></div>
